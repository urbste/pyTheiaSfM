...
std::tuple<Eigen::Matrix3d, Eigen::Matrix3d, Eigen::Vector3d>
DecomposeEssentialMatrixWrapper(const Eigen::Matrix3d &essential_matrix);

Eigen::Matrix3d
EssentialMatrixFromTwoProjectionMatricesWrapper(const Matrix3x4d &pose1,
                                                const Matrix3x4d &pose2);

std::tuple<int, Eigen::Matrix3d, Eigen::Vector3d>
GetBestPoseFromEssentialMatrixWrapper(
    const Eigen::Matrix3d &essential_matrix,
    const std::vector<FeatureCorrespondence> &normalized_correspondences);

std::tuple<bool, std::vector<Eigen::Matrix<double, 3, 4>>,
...
FivePointRelativePoseWrapper(const std::vector<Eigen::Vector2d> &image1_points,
...
std::tuple<bool, std::vector<Eigen::Matrix3d>, std::vector<Eigen::Vector3d>,
           std::vector<double>, std::vector<double>>
FourPointsPoseFocalLengthRadialDistortionWrapper(
    const std::vector<Eigen::Vector2d> &feature_vectors,
    const std::vector<Eigen::Vector3d> &world_points);

std::tuple<bool, Eigen::Matrix3d>
FourPointHomographyWrapper(const std::vector<Eigen::Vector2d> &image_1_points,
                           const std::vector<Eigen::Vector2d> &image_2_points);
...
FocalLengthsFromFundamentalMatrixWrapper(const Eigen::Matrix3d fmatrix);

std::tuple<bool, double>
SharedFocalLengthsFromFundamentalMatrixWrapper(const Eigen::Matrix3d fmatrix);
...
Eigen::Matrix3d
EssentialMatrixFromFundamentalMatrixWrapper(const Eigen::Matrix3d fmatrix,
...
std::tuple<bool, Eigen::Vector3d> PositionFromTwoRaysWrapper(
    const Eigen::Vector2d &rotated_feature1, const Eigen::Vector3d &point1,
    const Eigen::Vector2d &rotated_feature2, const Eigen::Vector3d &point2);
...
std::tuple<std::vector<Eigen::Matrix<double, 4, 1>>,
           std::vector<Eigen::Vector3d>, std::vector<double>>
...
std::tuple<int, std::vector<Eigen::Matrix<double, 4, 1>>,
           std::vector<Eigen::Vector3d>>
TwoPointPosePartialRotationWrapper(const Eigen::Vector3d &axis,
