...
std::tuple<Eigen::Matrix3d, Eigen::Vector3d, double>  AlignPointCloudsUmeyamaWrapper(
...
std::tuple<Eigen::Matrix3d, Eigen::Vector3d, double> AlignReconstructionsWrapper(
