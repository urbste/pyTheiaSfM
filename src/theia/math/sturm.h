...
// misc/sturm.h, commit fa7280fee27f97aff31ae7f98bab7f583fac7d08, and is
// distributed under the BSD-3-Clause license. See
// docs/licenses/POSELIB_LICENSE.txt for the full PoseLib license text.
//
// Sturm-sequence root bracketing, used by the ported Nister/Sturm 5-point
// relative pose solver (five_point_relative_pose_sturm.h) to find the real
// roots of the degree-10 polynomial without ever forming an eigendecomposition.
// Reference: D. Nistér, "An Efficient Solution to the Five-Point Relative
// Pose Problem", IEEE TPAMI, 2004.

#ifndef THEIA_MATH_STURM_H_
#define THEIA_MATH_STURM_H_
