...
class DivisionUndistortionCameraModel(CameraIntrinsicsModel):
    ...
    def kIntrinsicsSize(*args, **kwargs):
        ...
class DoubleSphereCameraModel(CameraIntrinsicsModel):
    @staticmethod
    ...
    def PrintIntrinsics(*args, **kwargs):
        ...
    @staticmethod
    def SetAlphaXiDistortion(*args, **kwargs):
        ...
    @staticmethod
    def SetAspectRatio(*args, **kwargs):
        ...
...
class EstimateTwoViewInfoOptions:
    ...
    def use_sturm_5pt(*args, **kwargs):
        ...
    @property
    def estimation_method(*args, **kwargs):
        ...
    ...
    def fast_iterative_5pt_options(*args, **kwargs):
        ...
class FastIterativeFivePointOptions:
    @staticmethod
    def __init__(*args, **kwargs):
        ...
    @property
    ...
    def max_iterations(*args, **kwargs):
        ...
    @property
    def initial_trust_region_radius(*args, **kwargs):
        ...
    ...
    def gradient_tolerance(*args, **kwargs):
        ...
    @property
    def residual_tolerance(*args, **kwargs):
        ...
    @residual_tolerance.setter
    def residual_tolerance(*args, **kwargs):
        ...
    @property
    def step_tolerance(*args, **kwargs):
        ...
    @step_tolerance.setter
    def step_tolerance(*args, **kwargs):
        ...
    @property
    def trust_region_tolerance(*args, **kwargs):
        ...
    @trust_region_tolerance.setter
    def trust_region_tolerance(*args, **kwargs):
        ...
    @property
    def prior_rotation(*args, **kwargs):
        ...
    @prior_rotation.setter
    def prior_rotation(*args, **kwargs):
        ...
    @property
    def prior_translation(*args, **kwargs):
        ...
    @prior_translation.setter
    def prior_translation(*args, **kwargs):
        ...
class TwoViewEstimationMethod:
    FIVE_POINT_STEWENIUS: typing.ClassVar[TwoViewEstimationMethod]
    FIVE_POINT_STURM: typing.ClassVar[TwoViewEstimationMethod]
    FAST_ITERATIVE_FIVE_POINT: typing.ClassVar[TwoViewEstimationMethod]
    MONODEPTH_THREE_POINT: typing.ClassVar[TwoViewEstimationMethod]
    @staticmethod
    def __init__(*args, **kwargs):
        ...
class ExtendedUnifiedCameraModel(CameraIntrinsicsModel):
    ...
    def PrintIntrinsics(*args, **kwargs):
        ...
    @staticmethod
    def SetAlphaBetaDistortion(*args, **kwargs):
        ...
    @staticmethod
    def SetAspectRatio(*args, **kwargs):
        ...
...
class PriorVector4d:
    ...
    def value(*args, **kwargs):
        ...
class RadialDistUncalibratedAbsolutePose:
    @staticmethod
    def __init__(*args, **kwargs):
        ...
    @property
...
def BundleAdjustPartialViewsConstant(*args, **kwargs):
    ...
def BundleAdjustPartialViewsConstantWithRelativePoseEdges(*args, **kwargs):
    ...
def BundleAdjustReconstruction(*args, **kwargs):
    ...
def BundleAdjustReconstructionWithConstantTracks(*args, **kwargs):
    ...
...
def FindCommonViewsByName(*args, **kwargs):
    ...
def FastIterativeFivePointRelativePose(*args, **kwargs):
    ...
def FivePointFocalLengthRadialDistortion(*args, **kwargs):
    ...
def FivePointOnePointGeneralizedRelativePose(*args, **kwargs):
    ...
def FivePointRelativePose(*args, **kwargs):
    ...
def FivePointRelativePoseSturm(*args, **kwargs):
    ...
