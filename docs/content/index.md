...
-   Added calibrated **multi-camera / stereo rigs** (`CameraRig`, `RigCapture`, incremental + global reconstructors); see [Rigs](rigs.md) (pyTheia **1.2.0+**; metric capture edges / `WriteRigPlyFile` in **1.2.1**)
